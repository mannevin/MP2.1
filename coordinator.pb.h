...
// bool active = 6;
inline void ServerInfo::clear_active() {
  _impl_.active_ = false;
}
inline bool ServerInfo::active() const {
  // @@protoc_insertion_point(field_get:csce438.ServerInfo.active)
  return _internal_active();
}
inline void ServerInfo::set_active(bool value) {
  _internal_set_active(value);
  // @@protoc_insertion_point(field_set:csce438.ServerInfo.active)
}
inline bool ServerInfo::_internal_active() const {
  return _impl_.active_;
}
inline void ServerInfo::_internal_set_active(bool value) {
  ;
